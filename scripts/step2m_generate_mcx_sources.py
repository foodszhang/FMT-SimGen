#!/usr/bin/env python3
"""Step 2m: Generate MCX JSON configs and source binaries from tumor_params.json.
...
Usage:
    python scripts/step2m_generate_mcx_sources.py --experiment verify_uniform_3
...
def main() -> None:
    ...
    parser.add_argument(
        "--experiment",
        type=str,
        default="verify_uniform_3",
        help="Experiment name (default: verify_uniform_3)",
    )
    parser.add_argument(
        "--sample_start",
        type=int,
